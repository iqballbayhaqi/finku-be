...
exports.restoreData = exports.exportData = void 0;
...
const exportData = async (req, res) => {
    try {
        ...
        const transactions = await prisma_1.default.transaction.findMany({ where: { userId } });
        ...
        const plannedExpenses = await prisma_1.default.plannedExpense.findMany({ where: { userId } });
        const backupData = {
            version: 1,
