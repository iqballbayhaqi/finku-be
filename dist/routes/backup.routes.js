...
router.get(
  ...
  backup_controller_1.exportData,
);
const backup_controller_2 = require("../controllers/backup.controller");
router.post(
  "/restore",
  auth_middleware_1.authenticateToken,
  backup_controller_2.restoreData,
);
const googleSheetsBackup_controller_1 = require("../controllers/googleSheetsBackup.controller");
router.get(
  "/sheets/service-account",
  auth_middleware_1.authenticateToken,
  googleSheetsBackup_controller_1.getServiceAccount,
);
router.post(
  "/sheets/export",
  auth_middleware_1.authenticateToken,
  googleSheetsBackup_controller_1.exportToGoogleSheets,
);
